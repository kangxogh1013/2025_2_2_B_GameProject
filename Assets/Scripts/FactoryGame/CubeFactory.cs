...
public class CubeFactory : MonoBehaviour
{
    ...
    public Transform woodStorage;               //목재 창고
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(10, 120, 250, 20), $"완제품(Dict) : {products[ProductType.Chair]} 개 보유");
        GUI.Label(new Rect(10, 140, 400, 20), $"요청서(List) : {requestList.Count} 개");
        ...
        GUI.Label(new Rect(300, 60, 150, 20), "1키 : 원료 큐 츄가");
        GUI.Label(new Rect(300, 80, 150, 20), "Q키 : 큐 -> 창고");
        GUI.Label(new Rect(300, 100, 150, 20), "A키 : 창고 -> 조립");
        GUI.Label(new Rect(300, 120, 150, 20), "S키 : 조립 (스택)");
        GUI.Label(new Rect(300, 140, 150, 20), "R키 : 요청 추가");
    }
