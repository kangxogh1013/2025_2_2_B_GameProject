...
public class DeliveryDriver : MonoBehaviour
{
    ...
    public  class DeliveryEvents                                //다양한 이벤트 정의 클래스 선언 
    {
        [Header("이동 Event")]
    ...
    public DeliveryEvents driverEvents;
    ...
    void Start()
    {
        ...
        driverEvents.OnDeliveryCountChanged?.Invoke(deliverCount);
    }
    ...
    {
        return $"돈 : {currentMoney:F0} 원 | 배터리 : {batteryLevel:F1}% | 배달 : {deliverCount} 건";
    }
    public bool CanMove()
    {
